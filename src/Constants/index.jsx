...
export const features = [
    {
      id: '0',
      icons: require('../images/feature-1.png'),
    ...
    {
      id: '1',
      icons: require('../images/feature-2.png'),
  ...
  export const details = [
    {
      id: '0',
      icon: require('../images/detail-1.png'),
      title: 'AI automated video editing',
    },
    {
      id: '1',
      icon: require('../images/detail-2.png'),
      title: 'Collaborate with your team',
    },
    {
      id: '2',
      icon: require('../images/detail-3.png'),
      title: 'Ultra fast cloud-engine',
    },
    {
      id: '3',
      icon: require('../images/detail-4.png'),
